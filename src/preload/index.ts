...
const api = {
  ...
  registerMicShortcut: (shortcut: string) =>
    ipcRenderer.invoke("register-mic-shortcut", shortcut),
  unregisterMicShortcut: () => ipcRenderer.invoke("unregister-mic-shortcut"),
  onProactiveSpeakToggle: (callback: () => void) => {
    const handler = (_event: any) => callback();
    ipcRenderer.on("proactive-speak-toggle", handler);
    return () => ipcRenderer.removeListener("proactive-speak-toggle", handler);
  },
  registerProactiveSpeakShortcut: (shortcut: string) =>
    ipcRenderer.invoke("register-proactive-speak-shortcut", shortcut),
  unregisterProactiveSpeakShortcut: () =>
    ipcRenderer.invoke("unregister-proactive-speak-shortcut"),
